...
function sanitizePostHtml(html: string): string {
	return sanitizeHtml(html, {
		...
		allowedAttributes: {
			...
			circle: ["cx", "cy", "fill", "opacity", "r", "stroke", "stroke-width"],
			line: [
				"marker-end",
				"opacity",
				"stroke",
			...
			marker: ["id", "markerheight", "markerwidth", "orient", "refx", "refy"],
			path: [
				"d",
				"fill",
				"marker-end",
			...
			pattern: ["height", "id", "patternunits", "width"],
			polygon: ["fill", "opacity", "points", "stroke", "stroke-width"],
			rect: [
				"fill",
				"height",
				"opacity",
			...
			text: ["fill", "font-size", "font-weight", "text-anchor", "x", "y"],
		},
